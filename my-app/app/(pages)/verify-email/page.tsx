    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-blue-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 flex items-center justify-center p-4">
      ...
      <div className="max-w-md w-full bg-white dark:bg-gray-900 rounded-2xl shadow-xl p-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-400">We've sent a 6-digit code to your email address</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          {/* Back to Signup */}
          <div className="text-center">
            <Link href="/SignUp" className="text-gray-600 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 text-sm">
              ← Back to Signup
            </Link>
          </div>
        </form>
